...
class ThemeproController extends LitElement {
	...
	_onCreateTheme() {
		const colorSelect = this.shadowRoot!.getElementById("customcolor") as HTMLSelectElement;
	...
	_onCreatePrimaryColor() {
		const primarySelect = this.shadowRoot!.getElementById("primarycolor") as HTMLSelectElement;

...
export class AutoFlex extends LitElement {
    ...
    private _updateRadius() {
        ...
        if (this.direction === "row") {
            ...
            children[0].style.borderBottomLeftRadius =
                "var(--auto-border-radius)";
            children[children.length - 1].style.borderTopRightRadius =
                "var(--auto-border-radius)";
            children[children.length - 1].style.borderBottomRightRadius =
                "var(--auto-border-radius)";
        } else {
            children[0].style.borderTopLeftRadius = "var(--auto-border-radius)";
            children[0].style.borderTopRightRadius =
                "var(--auto-border-radius)";
            children[children.length - 1].style.borderBottomLeftRadius =
                "var(--auto-border-radius)";
            children[children.length - 1].style.borderBottomRightRadius =
                "var(--auto-border-radius)";
        }

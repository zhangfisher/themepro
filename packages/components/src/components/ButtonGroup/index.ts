...
@customElement('kylin-button-group')
export class KylinButtonGroup extends KylinElementBase<KylinButtonGroupProps> {
...
declare global {
    interface HTMLElementTagNameMap {
        'kylin-button-group': KylinButtonGroup
    }
}

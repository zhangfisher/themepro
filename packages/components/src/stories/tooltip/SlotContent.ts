                ...
                return html`
                    ...
                    <div style="display: none;">
                        ...
                        <slot name="warning-content">
                            <div
                                style="padding: 8px; background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 4px;"
                            >
                    ...
                    <div style="display: none;">
                        <slot name="user-info">
                            <div style="padding: 12px; min-width: 200px;">
                                ...
                                >
                                    <div
                                        style="width: 40px; height: 40px; background: #007bff; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold;"
                                    >
                                        U
                                    </div>
                                    <div>
                                ...
                                <div
                                    style="border-top: 1px solid #eee; padding-top: 8px; font-size: 12px;"
                                >
                        ...
                        <slot name="status-info">
                            <div style="padding: 12px;">
                                ...
                                >
                                    <div
                                        style="width: 12px; height: 12px; background: #28a745; border-radius: 50%;"
                                    ></div>
...
export const 基础Slot内容: Story = {
    name: "基础Slot内容",
    render: () =>
        html`<tooltip-slot-demo story-type="basic"></tooltip-slot-demo>`,
    parameters: {
        docs: {
            description: {
...
export const 动态Slot内容: Story = {
    name: "动态Slot内容",
    render: () =>
        html`<tooltip-slot-demo story-type="dynamic"></tooltip-slot-demo>`,
    parameters: {
        docs: {
            description: {
        ...
        <div class="responsive-demo">
            <div class="responsive-buttons">
                ...
                <div
                    ...
                    data-tooltip="slot::online-details"
                    data-tooltip-placement="right"
                    data-tooltip-arrow="true"
                >
                    <span
            ...
            <div slot="connection-status">
                <div style="padding: 12px;">
                    ...
                    <div style="font-size: 14px; line-height: 1.5;">
                        ...
                        <div>
                            <strong>延迟：</strong
                            ><span id="latency">45</span>ms
                        </div>
                        <div
                            style="margin-top: 8px; color: #28a745; font-size: 12px;"
                        >
                            ✅ 连接正常
                        </div>
                    </div>

export const derivedVars = {
    ...
    "--auto-selected-bgcolor":
        "color-mix(in srgb, var(--t-theme-bgcolor-1), transparent 15%)!important",

    "--auto-hover-color": "var(--t-color-theme-6)!important",
    "--auto-hover-bgcolor":
        "color-mix(in srgb, var(--t-theme-bgcolor-1) 50%, transparent 5%)!important",

    "--auto-disable-color":
        "color-mix(in srgb, var(--t-color-theme-3), transparent 50%)!important",
    ...
    "--auto-secondary-color":
        "color-mix(in srgb, var(--auto-color), white 60%)",
    ...
    /* 排版/字体 */
    "--auto-font":
        "var(--auto-font-weight) var(--auto-font-size)/1.5 var(--auto-font-family)",
    "--auto-font-family":
    ...
    "--auto-panel-header-bgcolor":
        "color-mix(in hsl, var(--auto-bgcolor), black 3%)",

...
${themeStyles}
	...
	var supportsAdoptingStyleSheets =
		global.ShadowRoot && // @ts-expect-error
		(global.ShadyCSS === void 0 || global.ShadyCSS.nativeShadow) &&
		"adoptedStyleSheets" in Document.prototype &&
		"replace" in CSSStyleSheet.prototype;
...
/* \u4E3B\u8272\u8C03 */
  ...
  `,
	...
	AutoListComponent = __decorateClass([t3("auto-list")], AutoListComponent);
  ...
  `;
	__decorateClass([n4()], AutoListItemComponent.prototype, "title", 2);
	AutoListItemComponent = __decorateClass([t3("auto-list-item")], AutoListItemComponent);
})();

...
Make sure to test your application with a production build as repeat registrations will throw in production.`);
  ...
  var i = (t4, ...e4) => {
    const o6 = 1 === t4.length ? t4[0] : e4.reduce(((e5, s4, o7) => e5 + ((t5) => {
  ...
  var g = class extends (globalThis.HTMLElement ?? HTMLElementShimWithRealType) {
    ...
    static createProperty(t4, s4 = y) {
      if (s4.state && (s4.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t4) && ((s4 = Object.create(s4)).wrapped = true), this.elementProperties.set(t4, s4), !s4.noAccessor) {
        const i4 = Symbol(), e4 = this.getPropertyDescriptor(t4, i4, s4);
    ...
    _$ET(t4, s4) {
      const i4 = this.constructor.elementProperties.get(t4), e4 = this.constructor._$Eu(t4, i4);
    ...
    _$AK(t4, s4) {
      const i4 = this.constructor, e4 = i4._$Eh.get(t4);
      if (void 0 !== e4 && this._$Em !== e4) {
        const t5 = i4.getPropertyOptions(e4), h3 = "function" == typeof t5.converter ? { fromAttribute: t5.converter } : void 0 !== t5.converter?.fromAttribute ? t5.converter : b;
        this._$Em = e4;
    ...
    requestUpdate(t4, s4, i4) {
      if (void 0 !== t4) {
        const e4 = this.constructor, h3 = this[t4];
        if (i4 ??= e4.getPropertyOptions(t4), !((i4.hasChanged ?? m)(h3, s4) || i4.useDefault && i4.reflect && h3 === this._$Ej?.get(t4) && !this.hasAttribute(e4._$Eu(t4, i4)))) return;
        this.C(t4, s4, i4);
      }
      false === this.isUpdatePending && (this._$ES = this._$EP());
    }
    C(t4, s4, { useDefault: i4, reflect: e4, wrapped: h3 }, r5) {
      i4 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t4) && (this._$Ej.set(t4, r5 ?? s4 ?? this[t4]), true !== h3 || void 0 !== r5) || (this._$AL.has(t4) || (this.hasUpdated || i4 || (s4 = void 0), this._$AL.set(t4, s4)), true === e4 && this._$Em !== t4 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t4));
    }
    async _$EP() {
    ...
    performUpdate() {
      ...
      if (!this.hasUpdated) {
        ...
        if (t5.size > 0) for (const [s5, i4] of t5) {
          const { wrapped: t6 } = i4, e4 = this[s5];
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var V = (t4, i4) => {
    ...
    let r5, l3 = 2 === i4 ? "<svg>" : 3 === i4 ? "<math>" : "", c4 = f2;
    for (let i5 = 0; i5 < s4; i5++) {
      const s5 = t4[i5];
      let a3, u3, d3 = -1, y3 = 0;
      for (; y3 < s5.length && (c4.lastIndex = y3, u3 = c4.exec(s5), null !== u3); ) y3 = c4.lastIndex, c4 === f2 ? "!--" === u3[1] ? c4 = v : void 0 !== u3[1] ? c4 = _ : void 0 !== u3[2] ? ($.test(u3[2]) && (r5 = RegExp("</" + u3[2], "g")), c4 = m2) : void 0 !== u3[3] && (c4 = m2) : c4 === m2 ? ">" === u3[0] ? (c4 = r5 ?? f2, d3 = -1) : void 0 === u3[1] ? d3 = -2 : (d3 = c4.lastIndex - u3[2].length, a3 = u3[1], c4 = void 0 === u3[3] ? m2 : '"' === u3[3] ? g2 : p2) : c4 === g2 || c4 === p2 ? c4 = m2 : c4 === v || c4 === _ ? c4 = f2 : (c4 = m2, r5 = void 0);
      const x2 = c4 === m2 && t4[i5 + 1].startsWith("/>") ? " " : "";
      l3 += c4 === f2 ? s5 + n3 : d3 >= 0 ? (o6.push(a3), s5.slice(0, d3) + e2 + s5.slice(d3) + h2 + x2) : s5 + h2 + (-2 === d3 ? i5 : x2);
    }
  ...
  var N = class _N {
    constructor({ strings: t4, _$litType$: s4 }, n5) {
      ...
      for (; null !== (r5 = C.nextNode()) && d3.length < u3; ) {
        if (1 === r5.nodeType) {
          if (r5.hasAttributes()) for (const t5 of r5.getAttributeNames()) if (t5.endsWith(e2)) {
            const i4 = v2[a3++], s5 = r5.getAttribute(t5).split(h2), e4 = /([.?@])?(.*)/.exec(i4);
            d3.push({ type: 1, index: c4, name: e4[2], strings: s5, ctor: "." === e4[1] ? H : "?" === e4[1] ? I : "@" === e4[1] ? L : R }), r5.removeAttribute(t5);
          ...
          if ($.test(r5.tagName)) {
            ...
            if (s5 > 0) {
              ...
              for (let i4 = 0; i4 < s5; i4++) r5.append(t5[i4], l2()), C.nextNode(), d3.push({ type: 2, index: ++c4 });
              r5.append(t5[s5], l2());
            }
          }
  ...
  function S2(t4, i4, s4 = t4, e4) {
    ...
    return h3?.constructor !== o6 && (h3?._$AO?.(false), void 0 === o6 ? h3 = void 0 : (h3 = new o6(t4), h3._$AT(t4, s4, e4)), void 0 !== e4 ? (s4._$Co ??= [])[e4] = h3 : s4._$Cl = h3), void 0 !== h3 && (i4 = S2(t4, h3._$AS(t4, i4.values), h3, e4)), i4;
  }
  var M = class {
    constructor(t4, i4) {
    ...
    u(t4) {
      const { el: { content: i4 }, parts: s4 } = this._$AD, e4 = (t4?.creationScope ?? r3).importNode(i4, true);
      C.currentNode = e4;
      let h3 = C.nextNode(), o6 = 0, n5 = 0, l3 = s4[0];
      for (; void 0 !== l3; ) {
        if (o6 === l3.index) {
          let i5;
          2 === l3.type ? i5 = new k(h3, h3.nextSibling, this, t4) : 1 === l3.type ? i5 = new l3.ctor(h3, l3.name, l3.strings, this, t4) : 6 === l3.type && (i5 = new z(h3, this, t4)), this._$AV.push(i5), l3 = s4[++n5];
        }
  ...
  var k = class _k {
    ...
    constructor(t4, i4, s4, e4) {
      this.type = 2, this._$AH = E, this._$AN = void 0, this._$AA = t4, this._$AB = i4, this._$AM = s4, this.options = e4, this._$Cv = e4?.isConnected ?? true;
    }
    get parentNode() {
    ...
    _$AI(t4, i4 = this) {
      t4 = S2(this, t4, i4), c3(t4) ? t4 === E || null == t4 || "" === t4 ? (this._$AH !== E && this._$AR(), this._$AH = E) : t4 !== this._$AH && t4 !== w && this._(t4) : void 0 !== t4._$litType$ ? this.$(t4) : void 0 !== t4.nodeType ? this.T(t4) : u2(t4) ? this.k(t4) : this._(t4);
    }
    O(t4) {
    ...
    $(t4) {
      const { values: i4, _$litType$: s4 } = t4, e4 = "number" == typeof s4 ? this._$AC(t4) : (void 0 === s4.el && (s4.el = N.createElement(P(s4.h, s4.h[0]), this.options)), s4);
      if (this._$AH?._$AD === e4) this._$AH.p(i4);
      else {
        const t5 = new M(e4, this), s5 = t5.u(this.options);
    ...
    k(t4) {
      ...
      const i4 = this._$AH;
      let s4, e4 = 0;
      for (const h3 of t4) e4 === i4.length ? i4.push(s4 = new _k(this.O(l2()), this.O(l2()), this, this.options)) : s4 = i4[e4], s4._$AI(h3), e4++;
  ...
  var R = class {
    ...
    constructor(t4, i4, s4, e4, h3) {
      this.type = 1, this._$AH = E, this._$AN = void 0, this.element = t4, this.name = i4, this._$AM = e4, this.options = h3, s4.length > 2 || "" !== s4[0] || "" !== s4[1] ? (this._$AH = Array(s4.length - 1).fill(new String()), this.strings = s4) : this._$AH = E;
    }
    _$AI(t4, i4 = this, s4, e4) {
      const h3 = this.strings;
      let o6 = false;
      if (void 0 === h3) t4 = S2(this, t4, i4, 0), o6 = !c3(t4) || t4 !== this._$AH && t4 !== w, o6 && (this._$AH = t4);
      else {
        const e5 = t4;
        let n5, r5;
        for (t4 = h3[0], n5 = 0; n5 < h3.length - 1; n5++) r5 = S2(this, e5[s4 + n5], i4, n5), r5 === w && (r5 = this._$AH[n5]), o6 ||= !c3(r5) || r5 !== this._$AH[n5], r5 === E ? t4 = E : t4 !== E && (t4 += (r5 ?? "") + h3[n5 + 1]), this._$AH[n5] = r5;
      }
      o6 && !e4 && this.j(t4);
    }
    j(t4) {
  ...
  var L = class extends R {
    ...
    _$AI(t4, i4 = this) {
      ...
      const s4 = this._$AH, e4 = t4 === E && s4 !== E || t4.capture !== s4.capture || t4.once !== s4.once || t4.passive !== s4.passive, h3 = t4 !== E && (s4 === E || e4);
  ...
  var i3 = class extends g {
    ...
    update(t4) {
      ...
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t4), this._$Do = j(r5, this.renderRoot, this.renderOptions);
    }
    connectedCallback() {
  ...
  var r4 = (t4 = o5, e4, r5) => {
    ...
    if (void 0 === s4 && globalThis.litPropertyMetadata.set(i4, s4 = /* @__PURE__ */ new Map()), "setter" === n5 && ((t4 = Object.create(t4)).wrapped = true), s4.set(r5.name, t4), "accessor" === n5) {
      const { name: o6 } = r5;
      return { set(r6) {
  ...
  function n4(t4) {
    return (e4, o6) => "object" == typeof o6 ? r4(t4, e4, o6) : ((t5, e5, o7) => {
      const r5 = e5.hasOwnProperty(o7);
      return e5.constructor.createProperty(o7, t5), r5 ? Object.getOwnPropertyDescriptor(e5, o7) : void 0;
    })(t4, e4, o6);
  }
  ...
  function rgbToHsl(color) {
    const [r5, g3, b3] = Array.isArray(color) ? color : toRGB(color);
    const rd = r5 / 255;
    const gd = g3 / 255;
    const bd = b3 / 255;
  ...
  function hslToRgb(hsl) {
    ...
    if (0 <= H2 && H2 < 1 / 6) {
      ...
      g3 = X;
      b3 = 0;
    } else if (1 / 6 <= H2 && H2 < 2 / 6) {
      r5 = X;
      g3 = C2;
      b3 = 0;
    } else if (2 / 6 <= H2 && H2 < 3 / 6) {
      r5 = 0;
      g3 = C2;
      b3 = X;
    } else if (3 / 6 <= H2 && H2 < 4 / 6) {
      r5 = 0;
      g3 = X;
      b3 = C2;
    } else if (4 / 6 <= H2 && H2 < 5 / 6) {
      r5 = X;
      g3 = 0;
      b3 = C2;
    } else {
    ...
    const toHex = (v2) => Math.round((v2 + m3) * 255).toString(16).padStart(2, "0");
    return `#${toHex(r5)}${toHex(g3)}${toHex(b3)}`;
  }
  ...
  function createVariantVars(prefix, options) {
    ...
    if (opts.levels) {
      ...
      opts.levels.slice(2).forEach((level, i4) => {
        vars[`${levelPrefix}-bgcolor-${i4 + 1}`] = `var(${prefix}${level})`;
      });
    }
...
${themeStyles}
  ...
  // src/webcomponent/lit.ts
  var ThemeProController = class {
    constructor(host) {
      this.host = host;
      ...
      // 配置observer监听data-theme属性变化
      this.observer.observe(this.host, { attributes: true, attributeFilter: ['data-theme'] });
    }
...
/* \u4E3B\u8272\u8C03 */
  ...
  // examples/list.ts
  var AutoListComponent = class extends i3 {
    constructor() {
      super(...arguments);
      this.themepro = new ThemeProController(this);
    }
    render() {
      return x`
      <div class="auto-list">
  ...
  AutoListComponent = __decorateClass([
    t3("auto-list")
  ], AutoListComponent);
  var AutoListItemComponent = class extends i3 {
    constructor() {
      super(...arguments);
      this.title = "";
    }
  ...
  AutoListItemComponent.styles = i`
    :host {
      display: block;
    }
    .list-item {
  ...
  __decorateClass([
    n4()
  ], AutoListItemComponent.prototype, "title", 2);
  AutoListItemComponent = __decorateClass([
    t3("auto-list-item")
